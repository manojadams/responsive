...
if(isset($_GET['search_u'])){
    get_template_part( 'search-result' );   exit;
}
...
class Search_User extends WP_Widget {
  ...
  function Search_User() {
    ...
    /* Create the widget. */
   $this->WP_Widget('postsfromcat-widget', 'Search Users', $widget_ops, $control_ops );
  }
...
function widget ($args,$instance) {
        ...
        <form action="<?php  echo   home_url(); // add_query_arg( 'foo', 'bar', $permalink ); ?>" method="get" name="forma">
            ...
            <select  style="width:50px" class="agbusca" name="edad_max"> 
                ...
                <option value="80">80</option>
                <option value="85">85</option>
                <option value="90" selected="v">90</option>
                <option value="95">95</option>
            </select> <br>
            ...
            <option value="BajoElect">BajoElect</option>
            <option value="BajoSexto">BajoSexto</option>
            ...
            <option value="">- TODO TIPO -</option>
                ...
                <option id="rpr_estilo-sureo" value="Sureño">Sureño</option>
            </select><br><br>
...
function searchuser_load_widgets() {
  register_widget('Search_User');
}
add_action('widgets_init', 'searchuser_load_widgets');
/*
*	Adding redirection functionalities
*/
...
function redirect_visitors() {
	...
	wp_reset_query();
	wp_redirect( 'http://www.musicodisponible.com/page='.$id );
	if (is_page('searchtest')) {//for  buscar musico page
        wp_redirect( 'http://www.musicodisponible.com/wp-login.php?action=register' );
        exit();
    }
}
?>